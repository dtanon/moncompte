...
class AuthService {
  ...
  Future<bool> login() async {
    ...
    String _result = await globals.Utility.postData(mapData);
    String _avatar, _firstName, _lastName, _id, _token;
    try {
      Map decoded = json.decode(_result);

      print("decoded :" + decoded['data']['Error'].toString());
...
*/
  ...
  static void showErrorLogin(BuildContext context) {
    ...
    //globals.Utility.showAlertPopup(context, "Info", "Please Try Logging In Again!\n" + globals.errorMessage);
