...
*/
  ...
  static Future<String> postData(Map params) async {
    var requestURL = "http://dev.incomm.fr/api_mobile/api/login/"+params.values.first+"/"+params.values.last;
    
    print(params.values.first);
    print("Request URL: " + requestURL);
